    ...
    <div class="column content gap-6">
      ...
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <div class="card2 bg-alt flex flex-col gap-2 text-center shadow-2xl">
          ...
          <Link class="btn btn-primary" href="/chat/97c70a44366a6535c145b333f973ea86dfdc2d7a99da618c40c64705ad98e322">
      ...
      <div class="flex flex-col gap-4">
        <div class="col-2 items-center text-center">
          ...
          <p class="text-xs">
            Icons by <Link external class="link" href="https://www.figma.com/community/file/1166831539721848736"
              >480 Design</Link
            >
          </p>
        </div>
        <div class="flex justify-center gap-4">
          <div class="tooltip" data-tip="Source Code">
            <Link external href="https://github.com/Red-Token/iz-collaborator">
              <Icon icon="code-2" />
            </Link>
          </div>
