...
<form class="column gap-4" onsubmit={preventDefault(next)}>
  ...
  <p>
    Great! We've encrypted your secret key and saved it to your device. If that didn't work, or if you'd rather save
    your key somewhere else, you can find the encrypted version below:
  </p>
  <Field>
    {#snippet label()}
